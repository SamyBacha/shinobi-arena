      ...
      outfits: [
        ...
        { name: 'Fire Wizard', folder: 'js/characters/Wanderer_Magician/img/outfit_2/Fire Wizard/',
          sheets: {
            ...
            shield:       { file: 'Shield.png',       frames: 14 },
            magic_sphere: { file: 'Magic_sphere.png', frames: 8  },
        ...
        { name: 'Lightning Mage', folder: 'js/characters/Wanderer_Magician/img/outfit_3/Lightning Mage/',
          sheets: {
            ...
            attack1:      { file: 'Attack_1.png',     frames: 10 },
            attack2:      { file: 'Attack_2.png',     frames: 4  },
            attack3:      { file: 'Attack_2.png',     frames: 4  },
            dead:         { file: 'Dead.png',         frames: 5  },
            hurt:         { file: 'Hurt.png',         frames: 3  },
            shield:       { file: 'Shield.png',       frames: 13 },
            magic_sphere: { file: 'Magic_sphere.png', frames: 7  },
