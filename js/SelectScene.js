...
class SelectScene extends Phaser.Scene {
  ...
  preload() {
    [...Object.values(CHARACTERS), ...Object.values(HIDDEN_CHARACTERS)].forEach(char => {
      ...
      this.load.spritesheet(key, base + char.folder + '/Idle.png', { frameWidth: fs, frameHeight: fs });
    });
    if (!this.cache.audio.exists('menu_click')) this.load.audio('menu_click', 'music/freesound_community-menu-click-89198.mp3');
    if (!this.cache.audio.exists('menu_nav'))   this.load.audio('menu_nav',   'music/freesound_community-menu-button-88360.mp3');
  }
